...
//=================	MAIN PROGRAM	==================
void cerv_encode(int** imgi, int NRi, int NCi, char* compImgNamei )
{
  int i,j;
  int DATA[10];
  int nrBM, nrBN, biti;
...
void cerv_decode(int** imgi, int NRi, int NCi, char* compImgNamei )
{
  compImgName = compImgNamei;
  outputFile = fopen ( compImgName , "rb" );
  start_inputing_bits();
